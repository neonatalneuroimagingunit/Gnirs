...
Hmain.plot.spectrumaxes = axes('parent', Hmain.plot.panel,...
...
Hmain.plot.buttonBwall = uicontrol('Parent', Hmain.plot.panel, ...
    'Style', 'pushbutton', ...
    'BackgroundColor', backgroundColor, ...
    'ForegroundColor', foregroundColor, ...
    'Units', 'normalized', ...
...
Hmain.plot.buttonBw1 = uicontrol('Parent', Hmain.plot.panel, ...
    ...
    'Callback', {@move_window, Hmain.plot, DataNIRS.MeasureInfo.AqInfo.UpdateRate}, ...
    'String', '<');
Hmain.plot.buttonFwall = uicontrol('Parent', Hmain.plot.panel, ...
    'Style', 'pushbutton', ...
    'BackgroundColor', backgroundColor, ...
    'ForegroundColor', foregroundColor, ...
    'Units', 'normalized', ...
...
Hmain.plot.bigaxes1.YAxis.Exponent = 0;
Hmain.plot.lines1_selection = findall(Hmain.plot.lines1, 'Type', 'Line');
set(Hmain.plot.lines1_selection, 'buttonDownFcn', {@change_line_width, channelColors, get(Hmain.plot.lines1_selection(1), 'LineWidth'), 2, Hmain.plot, Hmain.metadata, DataNIRS.MeasureInfo.AqInfo.UpdateRate})
...
uistack(Hmain.plot.spectrumaxes,'top');
%% Overall plot
