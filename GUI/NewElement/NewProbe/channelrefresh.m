...
sourceTag = GHandle.TempWindow.SourceList.String;
	...
	if nChannel
		GHandle.TempWindow.Source = text([GHandle.TempWindow.LandMark(channelPairs(:,1)).XData],...
			...
			num2cell(num2str(channelPairs(:,1)),2)', ...
			'FontWeight', 'bold', ...
			'FontSize', 10, ...
			'HitTest', 'off', ...
			'Color', sourceColor);
		GHandle.TempWindow.Detector = text([GHandle.TempWindow.LandMark(channelPairs(:,2)).XData],...
			...
			num2cell(num2str(channelPairs(:,2)),2)', ...
			'FontWeight', 'bold', ...
			'FontSize', 10, ...
			'HitTest', 'off', ...
			'Color', detectorColor);
		...
		GHandle.TempWindow.ChannelText= text(coordChannel(:,1), coordChannel(:,2), coordChannel(:,3),GHandle.TempWindow.ChannelList.Data{iChannel,1}, ...
			'FontWeight', 'bold', ...
			'FontSize', 10, ...
			'HitTest', 'off', ...
			'Color', 'k');
