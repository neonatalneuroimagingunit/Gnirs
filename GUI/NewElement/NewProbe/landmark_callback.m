...
if GHandle.TempWindow.Zoom
	...
	if GHandle.TempWindow.AtlasWidget.SelectedIndex == 1
		...
		pointTag = Handle.Tag;
		pointMask = strcmp(GHandle.TempWindow.SelectedAtlas.LandMarks.names ,pointTag);
		nearPoins = GHandle.TempWindow.SelectedAtlas.LandMarks.neighbors{pointMask};
    ...
    nSrc = size(sourceTag,1);
    nDet = size(detectorTag,1);
	channelPairs = combvec(1:nSrc,1:nDet);
