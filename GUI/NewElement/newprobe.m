...
GHandle.TempWindow.ChannelListTitle = uicontrol('Style', 'text',...
    ...
    'Units', 'normalize', ...
    'HorizontalAlignment', 'left', ...
    'Position', [0.05 0.45 0.42 0.02]);

GHandle.TempWindow.ChannelList = uitable(...
    'Parent', GHandle.TempWindow.NewProbeFigure, ...
    'Units', 'normalize', ...
    'Data', [], ...
    'ColumnName', {'S', 'D', 'SD distance'}, ...
    'ColumnWidth', 'auto', ...
    'Position',  [0.05 0.05 0.42 0.40]);
...
%     result      = x(sort(index(1:n)))
    ...
    for ss = 1:1:nSrc
        for dd = 1:1:nDet
            ...
            tempdatatable(cc,:) = [ss dd tempchanneldistance];
            GHandle.TempWindow.ChannelList.Data = tempdatatable;
