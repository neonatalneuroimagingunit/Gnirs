...
for iStudy = 1:GHandle.DataBase.nStudy
    ...
    uimenu(GHandle.Main.Tree.Study(iStudy).ContextMenu,...
        'Label','Add subject template',...
        'callback',{@addsubjecttemplate ,GHandle, GHandle.DataBase.Study(iStudy).id});
    uimenu(GHandle.Main.Tree.Study(iStudy).ContextMenu,...
        'Label','Delete',...
...
GHandle.MethodWindow = MetodWW(GHandle.MethodWindow.MethodList, GHandle, analysisId);
end
