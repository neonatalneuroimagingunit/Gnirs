...
GHandle.Viewer(vIdx).PlotPanel.Time.SmallAxes = axes('parent', GHandle.Viewer(vIdx).PlotPanel.TimeTab,...
    ...
    'XGrid', 'off', ...
    'YGrid', 'off');
GHandle.Viewer(vIdx).PlotPanel.Time.SmallAxes.XAxis.Visible = 'off';
GHandle.Viewer(vIdx).PlotPanel.Time.SmallAxes.YAxis.Visible = 'off';
...
GHandle.Viewer(vIdx).PlotPanel.Time.XEditMin = uicontrol('Parent', GHandle.Viewer(vIdx).PlotPanel.TimeTab, ...
    ...
    'FontAngle', 'italic', ...
    'Tag','min',...
    'Callback', {@move_time_window, GHandle, vIdx,viewerC}, ...
    'String', 'min');
...
GHandle.Viewer(vIdx).PlotPanel.Time.YEditMin = uicontrol('Parent', GHandle.Viewer(vIdx).PlotPanel.TimeTab, ...
    ...
    'String', 'min',...
    'Tag','min',...
    'Callback', {@editY_callback, GHandle, vIdx,viewerC});
...
function move_time_window(~, eventData, GHandle, vIdx, viewerC)
small_step = 1;
big_step = 10;
