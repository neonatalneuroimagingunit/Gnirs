...
GHandle.TempWindow.LandmarkDensityLabel = uicontrol('Style', 'text',...
    'Parent', GHandle.TempWindow.WidgetPanel, ...
    'String', 'Landmark Density',...
    'BackgroundColor', BackgroundColor, ...
    'ForegroundColor', ForegroundColor, ...
    'Visible','on',...
    'Units', 'normalize', ...
...
GHandle.TempWindow.LandmarkDensityPopup = uicontrol('Style', 'popup',...
    'Parent', GHandle.TempWindow.WidgetPanel, ...
    'String', {'1','2','3','5','10 (not recommended)'},...
    'BackgroundColor', BackgroundColor, ...
    'ForegroundColor', ForegroundColor, ...
    'Visible','on',...
    'Units', 'normalize', ...
    'HorizontalAlignment', 'left', ...
    'Position', [0.4 0.05 0.55 0.05]);
...
GHandle.TempWindow.GreyBar.String =  [repmat(char(9608),[1 ii]) repmat(char(9621),[1 10-ii])];
drawnow;
end
...
GHandle.TempWindow.WhiteBar.String =  [repmat(char(9608),[1 ii]) repmat(char(9621),[1 10-ii])];
drawnow;
end
...
GHandle.TempWindow.ScalpBar.String =  [repmat(char(9608),[1 ii]) repmat(char(9621),[1 10-ii])];
drawnow;
end
...
GHandle.TempWindow.VoxelBar.String =  [repmat(char(9608),[1 ii]) repmat(char(9621),[1 10-ii])];
drawnow;
end
...
GHandle.TempWindow.HeadBar.String =  [repmat(char(9608),[1 ii]) repmat(char(9621),[1 10-ii])];
drawnow;
end
...
GHandle.TempWindow.LandmarkBar.String =  [repmat(char(9608),[1 ii]) repmat(char(9621),[1 10-ii])];
drawnow;
end
