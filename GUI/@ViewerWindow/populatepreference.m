...
obj.Panel.Preference.CheckBoxShowEventRectangle = uicontrol(...
    'Parent', obj.Panel.PanelPreference, ...
    'Style', 'checkbox', ...
    'BackgroundColor', obj.Preference.backgroundColor, ...
    'ForegroundColor', obj.Preference.foregroundColor, ...
    ...
    'FontWeight', 'bold', ...
    'Value', true,...
    'Callback', @(h,e)show_events_rectangle(h, e, obj),...
    'FontSize', 8, ...
    'FontAngle', 'italic', ...
    'HorizontalAlignment', 'right', ...
    'String', 'Show Events Rectangles');
...
function show_events_rectangle(handle, ~, obj)
if handle.Value
    set(obj.Panel.Plot.Time.EventsRectangle, 'Visible', 'on');
else
    set(obj.Panel.Plot.Time.EventsRectangle, 'Visible', 'off');
end
end