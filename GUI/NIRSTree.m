...
function displaymeasure(Measure, PreViwerHandle)
	...
	set(PreViwerHandle.TextBox(1,5),...
		...
		set(PreViwerHandle.PlotSubPannel,...
		'Visible', 'on'...
		);
		...
		plot(PreViwerHandle.Axes, Measure.Analysis.Ldata.reltime,Measure.Analysis(1).Ldata{:,dcIdx});
	
	
		
end

function displayanalysis(Measure, Analysis, PreViwerHandle)
	erasepannel(PreViwerHandle)
	...
	set(PreViwerHandle.TextBox(1,5),...
		...
		set(PreViwerHandle.TextBox(1,8),...
		'Label', 'Analysis',...
		...
		plot(PreViwerHandle.Axes, Measure.Analysis.Ldata.reltime,Analysis.Ldata{:,dcIdx});
