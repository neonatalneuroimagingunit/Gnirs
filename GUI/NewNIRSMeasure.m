...
function	LoadDatatoNewMeasureGUI(~ ,~ ,StudyFigureHandle, MainHandle)
		...
		if exist(selectedMeasurePath , 'file')	
			...
			DataNIRS = LoadBOXYdata(selectedMeasurePath, 'c', MainHandle.Tree.StudyNode(selectedStudyIdx).NewMeasures.MainNode ); %load all the data present in the file
