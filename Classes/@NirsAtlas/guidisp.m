function  guidisp(Atlas, GHandle , editableField)
    ...
    [iMask, jMask] = find(~cellfun('isempty',Atlas.LandMarks.names));
	GHandle.Main.Display.SubPanel(idx).LandMark = plot3(...
		reshape(Atlas.LandMarks.coord(iMask,jMask,1),[],1),... 
		reshape(Atlas.LandMarks.coord(iMask,jMask,2),[],1),... 
		reshape(Atlas.LandMarks.coord(iMask,jMask,3),[],1),...
		'MarkerSize',20,...
		'LineStyle', 'none',...
		'Visible', 'on',...
		'Marker','none',...
	...
	GHandle.Main.Display.SubPanel(idx).LandMarkText = text(...
		...
		reshape(Atlas.LandMarks.coord(iMask,jMask,2),[],1),... 
		reshape(Atlas.LandMarks.coord(iMask,jMask,3),[],1),...
		reshape(Atlas.LandMarks.names(iMask,jMask),[],1),...
		'FontName',fontName,...
		'Color','g',...
		'FontWeight','bold',...
		'Visible', 'off');
